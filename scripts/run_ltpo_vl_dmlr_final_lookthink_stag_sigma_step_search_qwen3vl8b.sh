#!/bin/bash
# run_ltpo_vl_dmlr_final_lookthink_stag_sigma_step_search.sh
#
...
# (output/ltpo_dmlr_final/0518_param_search_perds_init_lookthink_stag,
#  as ranked by scripts/find_best_grid.py).
#
# Per-dataset frozen lookthink-stag hyperparameters:
#                       lr      top_p   stag
#   math_vista_dev      1e-3    0.5     2
#   math_vision_dev     1e-3    0.9     5
#   mm_math_dev         1e-4    0.9     5
#   hallusion_dev       1e-3    0.5     2
#   mmvp_dev            1e-3    0.9     2
#   mmstar_dev          1e-4    0.5     2
#   scienceqa_dev       1e-3    0.5     5
#
...
#
# Usage:
#   bash scripts/run_ltpo_vl_dmlr_final_lookthink_stag_sigma_step_search.sh
#
...
root_output=./output/ltpo_dmlr_final/0520_param_search_perds_init_lookthink_stag_sigma_step_qwen3vl8b
mkdir -p "${root_output}"
...
echo "========================================================"
echo "LTPO-DMLR FINAL LOOK/THINK-STAG (sigma, steps) param-search"
