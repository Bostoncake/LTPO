...
ltpo_vl_dmlr_final, which keeps ``image_grid_thw`` alongside the
pre-merged ``inputs_embeds`` so Qwen2.5-VL uses proper mRoPE
position_ids throughout the LTPO path.
"""
