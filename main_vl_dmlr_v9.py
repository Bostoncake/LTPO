...
from ltpo_vl_dmlr_v9 import generate_vl, SYSTEM_PROMPT, BASELINE_SYSTEM_PROMPT
...
def main(args):
    ...
    system_prompt = BASELINE_SYSTEM_PROMPT if args.eval_baseline else SYSTEM_PROMPT
    if args.verbose:
